...
lis_int = [power_mod(num, k3, k1) for num in lis_int_c]
...
text_dig = ''.join(lis_dig)

text = ''.join([KEYS2[text_dig[2*idx:2*(idx + 1)]]\
                for idx in range(len(text_dig) // 2) ])
